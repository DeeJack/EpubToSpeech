...
@reader_namespace.doc(
    responses={200: "OK", 400: "Invalid Argument", 500: "Mapping Key Error"},
    description="Show the text for a chapter",
    params={"book_id": "The ID of the book", "chapter": "The chapter's number"},
)
...
@reader_namespace.doc(
    responses={200: "OK", 400: "Invalid Argument", 500: "Mapping Key Error"},
    description="Show the list of chapters to choose from",
...
@reader_namespace.doc(
    responses={200: "OK", 400: "Invalid Argument", 500: "Mapping Key Error"},
    description="Translate the chapter",
    params={"book_id": "The ID of the book", "chapter": "The chapter's number"},
)
...
@reader_namespace.doc(
    ...
    params={"prompt": "The prompt for the image"},
)
