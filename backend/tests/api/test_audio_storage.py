...
def test_storage(client):
    # Test storing a file
    response = client.post('/api/audio_storage/store-file', data={'file': (io.BytesIO(b'Hello World'), 'hello_world.txt'), 'filename': 'hello_world.txt'}, content_type='multipart/form-data')
